...
HRESULT Engine::CRenderTargetMgr::Intiailize_RenderTarget(LPDIRECT3DDEVICE9 pGraphicDev,
...
HRESULT CRenderTargetMgr::Initialize_MRT(const _tchar * pMRTTag, const _tchar * pTargetTag)
{
	CRenderTarget*		pRenderTarget = Find_RenderTarget(pTargetTag);
...
HRESULT CRenderTargetMgr::Initialize_DebugBuffer(const _tchar* pTargetTag, const _float & fX, const _float & fY, const _float & fSizeX, const _float & fSizeY)
{
	CRenderTarget*		pRenderTarget = Find_RenderTarget(pTargetTag);
	NULL_CHECK_RETURN(pRenderTarget, E_FAIL);
